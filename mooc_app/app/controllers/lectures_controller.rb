class LecturesController < ApplicationController
  ...
  before_action :set_lecture, only: [:show, :edit, :update, :destroy, :upvote, :downvote, :spam, :unspam]
  # GET /lectures
  # GET /lectures.json
  def index
  ...
  def create
    ...
    respond_to do |format|
      if @lecture.save
        format.html { redirect_to course_path(@course), notice: 'Lecture was successfully created.' }
        format.json { render :show, status: :created, location: course_path(@course) }
      else
